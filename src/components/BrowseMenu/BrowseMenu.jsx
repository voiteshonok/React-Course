...
export function BrowseMenu() {
    return (
        <div className='BrowseMenu'>
            ...
            <div className='BrowseMenu__text'>Use our menu to place an order online, or <span class="tooltip">phone<span class="tooltiptext">+375775778</span></span> our store to place a pickup order. Fast and fresh food.</div>
